    ...
    <div class="profile-content">
        <section class="my-recipes">
            <div class="section-header">
                <h2>My Recipes</h2>
                <a href="<?php echo url_for('/private/recipes/new.php'); ?>" class="btn btn-primary">
            ...
            <?php if(empty($recipes)) { ?>
                <div class="empty-state">
                    ...
                    <a href="<?php echo url_for('/private/recipes/new.php'); ?>" class="btn btn-primary">Create Your First Recipe</a>
                </div>
            <?php } else { ?>
                        ...
                        <div class="recipe-card">
                            ...
                            <div class="recipe-content">
                                ...
                                <div class="recipe-actions">
                                    ...
                                    <a href="<?php echo url_for('/private/recipes/edit.php?id=' . h(u($recipe->recipe_id))); ?>" 
                                       class="btn btn-primary">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <a href="<?php echo url_for('/private/recipes/delete.php?id=' . h(u($recipe->recipe_id))); ?>" 
