    ...
    <div class="profile-content">
        <section class="my-recipes">
            <div class="section-header">
                <h2>My Recipes</h2>
                <a href="<?php echo url_for('/recipes/new.php?ref=profile'); ?>" class="btn btn-primary">
            ...
            <?php if(empty($recipes)) { ?>
                <div class="empty-state">
                    ...
                    <a href="<?php echo url_for('/recipes/new.php?ref=profile'); ?>" class="btn btn-primary">Create Your First Recipe</a>
                </div>
            <?php } else { ?>
